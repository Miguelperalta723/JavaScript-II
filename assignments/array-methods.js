...
// Problem 1
// the race is over, but now we need a list of the runners email adresses to invite them to the next event
let emails = [];
...
// Problem 2
//the event would like to invite everyone who donated more than $100 to a special dinner, return a list of the runners who donated more tham $100
...
// Problem 3
//The event director needs to have all the runner's last names converted to uppercase because the director BECAME DRUNK WITH POWER AGAIN. Convert each first name into all caps and log the result
let lastNamesCaps = runners.map(function(runner){
        return runner.last_name.toUpperCase()
    })
console.log(lastNamesCaps); 